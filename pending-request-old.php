...
while ($row = mysqli_fetch_assoc($select_meeting_query)) {
 ...
 <td><button type='submit' class='btn btn-success' href='pending-request.php?approve=$id'>APPROVE</button></td>
 <td><button type='' class='btn btn-danger' href='pending-request.php?unapprove=$id'>UNAPPROVE</button></td>
