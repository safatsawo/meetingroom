        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title m-b-0">Declined Requests</h5>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
...
while ($row = mysqli_fetch_assoc($select_meeting_query)) {
    ...
    ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Accepted meetings for the year</h5>
                            <div class="table-responsive">
...
$select_all_from_accepted = mysqli_query($connection, $query);

while ($row = mysqli_fetch_assoc($select_all_from_accepted)) {
    $Requester = $row['Requester'];
    $Purpose = $row['Purpose'];
